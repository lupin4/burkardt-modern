...
!    NG =(N+1)*((N+1)*(N+2))/2.
!
!    Output, double precision G(3,NG), the coordinates
!    of the grid points.
!
  implicit none
...
!
!    Input, double precision G(3,NG), the grid point coordinates.
!
...
!  Parameters:
!
!    Output, double precision V1(3), V2(3), V3(3), V4(3), V5(3), V6(3),
!    the vertices.
!
  implicit none
