...
!
!    Output, double precision LINE_DATA(3,2,LINE_NUM), for each line I, the 
...
!
  ...
  integer j
  integer l
  double precision line_data(3,2,line_num)
  integer n
...
!
!    Input, double precision XG(3,NG), the Fibonacci spiral points.
!
!    Input, integer LINE_NUM, the number of grid lines.
!
!    Input, double precision LINE_DATA(3,2,LINE_NUM), contains pairs of 
