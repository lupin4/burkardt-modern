...
!
  ...
  double precision , dimension ( 3, node_num ) :: node_xyz
...
!    the input mesh.
!
!    Input, double precision NODE_XYZ1(3,NODE_NUM1), the coordinates of
...
!
!    Output, double precision NODE_XYZ2(3,NODE_NUM2), the coordinates of
...
!
!    Input, double precision NODE_XYZ(3,NODE_NUM), the coordinates 
!    of the nodes.
!
...
!
!    Input, double precision QUAD_XYZ(3,QUAD_NUM), the abscissas of the 
...
!
!    Output, double precision REGION_VOLUME, the volume of the region.
!
  implicit none
...
!    indices of the nodes.
!
!    Output, double precision TET_QUALITY(TET_NUM), the quality
...
!    Input, integer NODE_NUM, the number of nodes.
!
!    Input, double precision NODE_XYZ(3,NODE_NUM), the coordinates of 
!    the nodes.
!
!    Input, integer TET_ORDER, the order of the tetrahedrons.
!
...
!
!    Input, double precision P(3), the coordinates of a point.
!
...
!  Parameters:
!
!    Input, double precision TET_XYZ(3,4) the coordinates of the vertices.
!
...
!
  ...
  double precision r8mat_det_4d
  double precision r8vec_norm
  double precision tet_xyz(1:dim_num,4)
...
!
!    Input, double precision PHY(3,N), the coordinates of physical points
!    to be transformed.
!
!    Output, double precision REF(3,N), the coordinates of the corresponding
...
!    Input, integer N, the number of points to transform.
!
!    Input, double precision REF(3,N), points in the reference tetrahedron.
!
!    Output, double precision PHY(3,N), corresponding points in the
