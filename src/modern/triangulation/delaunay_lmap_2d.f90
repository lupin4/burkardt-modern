...
!
!    Input, double precision MATRIX(2,2), a linear map to be implicitly applied
!    to the points.
!
!    Output, integer DIAEDG_LMAP, chooses a diagonal:
...
!    of the vertices.
!
!    Input, double precision MATRIX(2,2), the linear map which should
...
!
!    Input, double precision MATRIX(2,2), the transformation matrix.
!
...
!  Parameters:
!
!    Input, double precision MATRIX(2,2), the linear map to be applied
!    to the data.
!
!    Input/output, double precision DX, DY, the components of the vector.
!
  implicit none
...
!
!    Input, double precision NODE_X(NODE_NUM), NODE_Y(NODE_NUM), 
