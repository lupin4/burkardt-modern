...
contains
  ...
  !
    ...
    real(dp) :: value
    real(dp) :: x
    real(dp), intent(in), value :: x1                                    !! x-coordinate of P1
    real(dp), intent(in), value :: x2                                    !! x-coordinate of P2
    real(dp), intent(in), value :: x3                                    !! x-coordinate of P3
    real(dp) :: y
    real(dp), intent(in), value :: y1                                    !! y-coordinate of P1
    real(dp), intent(in), value :: y2                                    !! y-coordinate of P2
    real(dp), intent(in), value :: y3                                    !! y-coordinate of P3
  ...
  !
    ...
    logical :: collinear
    logical :: value
    real(dp), intent(in), value :: xa                                    !! x-coordinate of vertex A
    real(dp), intent(in), value :: xb                                    !! x-coordinate of vertex B
    real(dp), intent(in), value :: xc                                    !! x-coordinate of vertex C
    real(dp) :: xmax
    real(dp) :: xmin
    real(dp), intent(in), value :: ya                                    !! y-coordinate of vertex A
    real(dp), intent(in), value :: yb                                    !! y-coordinate of vertex B
    real(dp), intent(in), value :: yc                                    !! y-coordinate of vertex C
    real(dp) :: ymax
    real(dp) :: ymin
  ...
  !
    ...
    integer(ip), intent(in), value :: n                                  !! number of vertices

    logical :: diagonal
    logical :: diagonalie
    integer(ip), intent(in), value :: im1                                !! index of first vertex
    logical :: in_cone
    integer(ip), intent(in), value :: ip1                                !! index of second vertex
  ...
  !
    ...
    real(dp), intent(in), value :: xb                                    !! x-coordinate of vertex B
    real(dp), intent(in), value :: xc                                    !! x-coordinate of vertex C
    real(dp), intent(in), value :: xd                                    !! x-coordinate of vertex D
    real(dp), intent(in), value :: ya                                    !! y-coordinate of vertex A
    real(dp), intent(in), value :: yb                                    !! y-coordinate of vertex B
    real(dp), intent(in), value :: yc                                    !! y-coordinate of vertex C
    real(dp), intent(in), value :: yd                                    !! y-coordinate of vertex D
  ...
  !
    ...
    logical, intent(in) :: l1                                            !! first logical value
    logical, intent(in) :: l2                                            !! second logical value
    logical :: l4_xor
    logical :: value1
    logical :: value2
